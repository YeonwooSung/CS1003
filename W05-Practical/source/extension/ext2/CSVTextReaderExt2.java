 ...
 * and save them in the array list. This class is same with the CSVTextReader class.
 * 
 * @author 160021429
 */
public class CSVTextReaderExt2 {
	...
	final int ZERO = 0;
	CSVTextReaderExt2(File inputFile) throws FileNotFoundException{
