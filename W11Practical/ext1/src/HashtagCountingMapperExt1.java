...
public class HashtagCountingMapperExt1 extends Mapper<LongWritable, Text, LongWritable, Text> {
	/**
	 * The aim of this method is to use Map function to sort the data with JsonObjectInformationExt1 instance.
	 * It throws InterruptedException and IOException to avoid potential problems. It uses ArrayList and
	 * Iterator to iterate all hash tags. Then it will send the output to the Combiner class.
