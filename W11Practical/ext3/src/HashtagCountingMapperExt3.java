 ...
 * @author 160021429
 */
public class HashtagCountingMapperExt3 extends Mapper<LongWritable, Text, Text, LongWritable> {
	/**
	...
	public void map(LongWritable key, Text text, Context output) throws IOException, InterruptedException {
		...
		try {
			JsonObjectInformationExt3 joi = new JsonObjectInformationExt3(jsonString);
