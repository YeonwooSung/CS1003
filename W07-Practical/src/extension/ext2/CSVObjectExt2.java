...
public class CSVObjectExt2 {
	...
	/**
	 * The aim of this method is returns the string that is the SQL query.
	 * @return
	 */
	public String stockQuery() { //check the duplication
	...
	public String customerQuery() {
		StringBuffer sb = new StringBuffer("");
		sb.append("INSERT IGNORE INTO customer ");
		sb.append("VALUES (?, ?)");
		//change StringBuffer to String by using the toString method and return it
		return sb.toString();
	}
