 ...
 * can be one of create, query1, query2, query3, query4, or query5.
 * 
 * @author 160021429
 *
 */
public class W07PracticalExt1 {
	...
	public static void main(String[] args) {
		...
		try { //try starts
			...
			//Class.forName("com.mariadb.jdbc.Driver"); // load the MariaDB driver
			...
			ActionExt1 a = new ActionExt1(); //create ActionExt1 object to use the SQL query
